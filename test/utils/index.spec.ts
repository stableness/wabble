...
describe('safe_init', () => {
    ...
    test.each([
        ...
        expect(safe_int ({ min: 3, max: 5 }) (n)).toBe(false);
    ...
    test.each([
        ...
        expect(safe_int ({                }) (n)).toBe(true);
        expect(safe_int ({ min: 3         }) (n)).toBe(true);
        expect(safe_int ({ min: 3, max: 5 }) (n)).toBe(true);
        expect(safe_int ({         max: 5 }) (n)).toBe(true);
...
describe('sendUDP', () => {
    ...
    test('timeout', () => expect(stdTE.unsafeUnwrap(
    ...
    test('echo', () => {
        ...
        return expect(stdTE.unsafeUnwrap(F.pipe(
